        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        <h4>EDIT DATA KARTU KELUARGA</h4>
                        <hr>
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`http://localhost:8000/api/kk/${route.params.id}`)
            .then(response => {
              
              //assign state posts with response data
              kk.nik    = response.data.data.nik  
              kk.nama_kepala  = response.data.data.nama_kepala  
              kk.jumlah_keluarga  = response.data.data.jumlah_keluarga  
              kk.rtrw  = response.data.data.rtrw  
              kk.alamat  = response.data.data.alamat  
        ...
        function update() {
            ...
            axios.put(`http://localhost:8000/api/kk/${route.params.id}`, {
                nik: nik,
